...
;CHECK:       Printing analysis 'Promote Memory to Register' for function 'main':
;CHECK-NEXT: Pass::print not implemented for pass: 'Promote Memory to Register'!
;CHECK-NEXT: Printing analysis 'Iterative Modulo Scheduling algorithm implementation':
;CHECK-NEXT: delta: 0
;CHECK-NEXT: blocks count: 3
;CHECK-NEXT: instructions count: 0
;CHECK-NEXT: =======-------=======
;CHECK-NEXT: Conf 1:
